          ...
          <div className="flex flex-col md:flex-row items-start gap-6">
            ...
            {currentUserId === userId ? (
              <Link
                ...
                className="w-full md:w-auto px-6 py-3 font-semibold rounded-xl transition-all shadow-md hover:shadow-lg bg-gradient-to-r from-[#4a5d3a] to-[#6b7d5a] hover:from-[#5a6d4a] hover:to-[#7b8d6a] text-white inline-flex items-center justify-center gap-2"
              >
