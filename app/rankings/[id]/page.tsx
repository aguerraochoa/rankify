          ...
          {(isEditing ? editableSongs : ranking.songs).map((song, index) => (
            ...
            >
              ...
              <div className="relative w-16 h-16 flex-shrink-0">
                ...
                <div className={`song-placeholder absolute inset-0 w-16 h-16 bg-gradient-to-br from-[#6b7d5a] to-[#4a5d3a] rounded-xl shadow-md flex items-center justify-center relative overflow-hidden ${song.cover_art_url ? 'hidden' : ''}`}>
